Feature: Product page states
  ...
  Scenario: Active product & visible redirect CTAs
    ...
    And the offer ends should be visible
  ...
  Scenario: Active product & hidden redirect CTAs
    ...
    And the offer ends should not be visible
    And the hotstats should be visible
    And the infoboxes should be visible
    And the must read box should not be visible
  ...
  Scenario Outline: Product data availability
    ...
    And the offer ends should be <offerEndsVisibility>
    ...
    Examples:
      | <productState> | <redirectsState> | <redirectCTAVisibility> | <offerEndsVisibility> | <hotstatsVisibility> | <infoboxesVisibility> | <mustReadBoxVisibility> |
      | active         | active           | visible                 | visible               | visible              | visible               | hidden                  |
      | active         | inacitve         | hidden                  | hidden                | visible              | visible               | hidden                  |
      | inactive       | n/a              | hidden                  | hidden                | hidden               | hidden                | visible                 |


    Scenario: Active product & empty redirect slug field
